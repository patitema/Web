...
<body>
    ...
    <main>
        <div class="Container">
            ...
            <div class="info_main"><p>Simply-Learn - сибирская компания с 2-х летним стажем работы в сфере продажи курсов. На нашем счету 200+ тыс клиентов, 1000+ препадователей и более 2-х тысяч проданых курсов. <br><br>
            Основатель Simply-Learn: Авхимович А.П - также непосредственно учавствующий в разработке и функционировании проекта. <br><br>Оффис компании находится в г.Барнаул по улице "Юрина, 194а 2э"</p>
            </div>
            </div>
        </div>
    </main>
